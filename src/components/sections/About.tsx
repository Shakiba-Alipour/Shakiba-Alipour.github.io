      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-16">
        ...
        >
          ...
          <p>
            ...
            TypeScript, Tailwind CSS, Zustand, Node.js — I picked up the entire
            modern front-end stack independently, driven by genuine curiosity
            and a need to build real things. There's something genuinely
            thrilling about turning a design into something you can hover,
            click, and scroll through. My{" "}
            <span className="text-text-primary font-medium">
              bachelor's thesis
            </span>{" "}
            — a weather forecast website built with JavaScript and Node.js — was
            my first proof of that: written without a mentor, entirely from
            scratch.
          </p>
          ...
          <p>
            ...
            <span className="text-text-primary font-medium">Foroushyar</span>, I
            led the complete front-end redevelopment of an AI-powered sales
          ...
          <p>
            ...
            members, and negotiated sponsorships. Those experiences shaped how I
            work on teams: with ownership, communication, and care.
          </p>

          {/* Paragraph 5 — Looking forward */}
          <p>
            I'm currently looking for opportunities where I can grow as an
            engineer — whether that's a challenging technical role or a graduate
            program that deepens my foundation. I work best in environments that
            take quality seriously and give people room to own their work.
          </p>
        </div>
        ...
        >
          <div>
            ...
            <p className="text-primary-100 text-sm leading-relaxed max-w-2xl">
              Technical skills are only part of the picture. For three years at
              FUM, I built the kind of leadership, communication, and
